...
describe('Slot 5 brand surface', () => {
  it('mcp.json card name is "Gvnr" and version 1.5.2', async () => {
  ...
  it('openapi.json title is "Gvnr" and version 1.5.2', async () => {
    ...
    expect(body.info.version).toBe('1.5.2');
